...
import { medicalCheckupItemMedicineState, medicalCheckupItemNewObject } from "@/States/MedicalCheckupItem";
...
export default function MedicalCheckupItemMedicine({ title, item, onSubmit, ...props }) {
        ...
        <div className="w-full">
            ...
            {medicalCheckupItem ? <Form className={'w-full text-gray-400 border-gray-200 border border-opacity-20 justify-center'}>
                ...
                <div className="w-full mr-4">
                    ...
                    <ItemListPopoverSearch itemTypeId={1} inStockOnly={true} currentItem={medicalCheckupItem.item} className='h-8 w-96 mr-2' onSelect={onSelectItem} />
                </div>
                <div className="mt-4">
                ...
                <div className="mt-4">
                    <InputLabel htmlFor="description" value="Signa" />
                    <TextInput
                        id="description"
                        type="text"
                        name="description"
                        ...
                        className="mt-1 block w-full h-8"
                        onChange={(e) => setMedicalCheckupItem({ ...medicalCheckupItem, signa: e.target.value })}
                    />
                </div>
