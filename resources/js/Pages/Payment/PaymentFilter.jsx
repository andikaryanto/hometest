...
import { paymentFilterState } from "@/States/Payment";
        ...
        <div className="mt-4">
            <div className="w-full mr-2">
                ...
                <TextInput
                    ...
                    type="text"
                    name="name"
                    value={paymentFilter.medical_record_number}
                    className={`mt-1 block w-full h-8 focus:border-none`}
                    isFocused={true}
                    onChange={(e) => setPaymentFilter({ ...paymentFilter, medical_record_number: e.target.value })}
                />
            </div>
            <div className="mt-4">
                <InputLabel htmlFor="clinic" value="Poli" />

                <ClinicListSelectInput className={`mt-1 block w-full h-8 focus:border-none`} onSelect={onSelectClinic} item={paymentFilter.clinic} />
